...
function get_CBS_varnames() {
    ...
    xhr.open('GET', 'data/otro/data_01.json', true);
    xhr.send(null);
}
...
get_CBS_varnames();
createInfoScreen('infopanel', 'ProyectoMainframe', 'SAKILA');
createInfoScreen('selection_screen', 'Selected variables', 'SAKILA DB');
